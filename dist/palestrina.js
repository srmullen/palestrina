...
function phrase() {
	...
	var ph = new Array(durations.length);
...
function having(prop, values, phrase) {
	return _.map(phrase, function (event, i) {
		var property = {};
...
function where(prop, fn, phrase) {
	...
	return _.map(phrase, function (event) {
		var property = {};
...
function but(start, end, variation, phrase) {
	var variationObject = _.mapKeys(_.take(variation, end - start), function (val, k) {
		return +k + start;
	});
...
function times(n, phrase) {
	return _.flatten(_.times(n, function () {
		return _.map(phrase, _.clone);
	}));
}

/* Sequences later after earlier */
function then(later, earlier) {
	var mapClone = _.partialRight(_.map, _.clone);
...
},{"../node_modules/lodash/index.js":1}],3:[function(require,module,exports){
"use strict";
...
},{"./melody":2,"./scale":4}],4:[function(require,module,exports){
"use strict";
...
},{"../node_modules/lodash/index.js":1}]},{},[3]);
